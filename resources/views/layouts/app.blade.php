                        ...
                        @else 
                            ...
                            <li class="nav-item">
                                <a href="{{route('products.cart')}}" class="nav-link" data-toggle="" aria-haspopup="true" aria-expanded="false">
                                    <i class="fa fa-shopping-basket"></i> <span class="badge badge-primary">{{ $cartCount }}</span>
                                </a>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <h5>About</h5>
                    <p>We partner with top brands like Apple, Samsung, OnePlus, Oppo, and more to ensure you get authentic products with full warranties. With a focus on quality, reliability, and customer satisfaction, Mobility is your one-stop shop for all things mobile.</p>
                </div>
                <div class="col-md-3">
                    <h5>Links</h5>
                    <ul>
                ...
                <div class="col-md-3">
                     ...
                     <ul>
                         <li>
                            <a href="tel:+620892738334"><i class="fa fa-phone"></i> 06667777777</a>
                        </li>
                        <li>
                            <a href="mailto:contact@mobility.com"><i class="fa fa-envelope"></i> contact@mobility.com</a>
                         </li>
                     </ul>
                ...
                <div class="col-md-3">
                     ...
                     <ul class="mb-0">
                        <li class="download-app">
                            <a href="#"><img src="{{ asset('assets/img/playstore.png') }}" alt="Google Play"></a>
                        </li>
                        <li class="download-app">
                            <a href="#"><img src="{{ asset('assets/img/appstore.png') }}" alt="Apple App Store"></a>
                        </li>
        ...
        <p class="copyright">&copy; 2025 Mobility | Mobile Store. All rights reserved.</p>
    </footer>
